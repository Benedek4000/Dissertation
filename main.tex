...
\maketitle
\begin{center}
        \makebox[\textwidth]{\includegraphics[width=\textwidth]{LU_Logo_Physics.jpg}}
\end{center}
\bigskip
\begin{abstract}
...
\section{Method/Graphs}\label{sec:method}
    ...
    \subsection{Assumptions and Data Processing}\label{sec:dataproc}
        ASSUMPTIONS ON DATA PROCESSING (E.G. SOLAR WIND IS ONLY PROTONS AND ELECTRONS), HOW THE DATA WAS PROCESSED
