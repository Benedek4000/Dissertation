...
\section{Discussion}\label{sec:discussion}
    \subsection{Reaction Time for Measurements at L1 Lagrange Point}
        ...
        \begin{equation}
            t=\frac{s}{v}=\frac{1.5*10^9}{8.7*10^5}=1700s=29\ minutes
        \end{equation}
        to reach Earth. As seen on Figure \ref{fig:hist_sw}, the solar wind speed can (very rarely) increase to approximately $1200km/s$, which would result in a reaction time of:
        \begin{equation}
            t=\frac{s}{v}=\frac{1.5*10^9}{1.2*10^6}=1250s=21\ minutes
        \end{equation}
        necessary, assuming constant solar wind speed.
